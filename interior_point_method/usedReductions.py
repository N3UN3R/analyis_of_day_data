...
def plot_usedReductions(timestamps,timeForTicker,nested_netCostDifference, nested_numberOfPairs, nested_lokalDistance, nested_konzessionsDifference):
    ...
    # create title
    averageCommunityPrice.set_title('Innere-Punkte-Methode: eingesetzte rechtliche Rahmenbedingungen 01. Oktober 2020')
    ...
    averageCommunityPrice.set_ylim(0,500)
  ...
  #                     Line2D([0], [0], color='black', label='local distance'),
   ...
   # plt.legend(handles=legend_elements, loc='best')
    ...
    #fig.savefig("ip_usedReductions.svg")
    fig.savefig("0104ip_usedReductions.pdf")
