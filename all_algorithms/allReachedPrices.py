...
def plot_reachedPrice(timestamps, numberOfProducers, network_reachedPrice_mean, kruskal_reachedPrice_mean, revised_reachedPrice_mean,
                  interior_reachedPrice_mean,simplex_reachedPrice_mean ):
    """ function that plots all data preperation times using
           matplotlib"""
    ...
    # create title
    #averageCommunityPrice.set_title('communityinterner Strompreis 01. Juli 2020')
    averageCommunityPrice.set_ylim(22,24)
    ...
    plt.plot(timestamps, network_reachedPrice_mean, color='blue')
    plt.plot(timestamps, kruskal_reachedPrice_mean, color = 'red')

    plt.plot(timestamps, revised_reachedPrice_mean, color = 'orange')
    plt.plot(timestamps, interior_reachedPrice_mean, color = 'black')
    plt.plot(timestamps, simplex_reachedPrice_mean, color = 'pink')
    ...
    fig.savefig("allReachedPrices_scalable.pdf")
    fig.savefig("allReachedPrices_scalable.svg")
...
def main():
    ...
    abbildung = plot_reachedPrice(timestamps, numberOfProducers, network_reachedPrice_mean, kruskal_reachedPrice_mean,
                              revised_reachedPrice_mean, interior_reachedPrice_mean, simplex_reachedPrice_mean)
