...
def plot_data_prep_times(timestamps, numberOfProducers, network_prepTime_mean,  kruskal_prepTime_mean,
...
def main():
    ...
    abbildung = plot_data_prep_times(timestamps, numberOfProducers, network_prepTime_mean,  kruskal_prepTime_mean,
                              simplex_prepTime_mean, revised_prepTime_mean, interior_prepTime_mean)
