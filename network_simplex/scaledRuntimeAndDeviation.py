...
def plot_dev(data,timestamps, sorted_runningTimes, runningTime_mean, runningTime_standard, plotting_timestamps):
    ...
    # create title
    averageCommunityPrice.set_title('Netzwerk-Simplex: Laufzeit 01. Januar 2020')
    averageCommunityPrice.set_ylim(0, 0.04)
   ...
   # fig.savefig("netz_runtime_deviation_scalable.svg")
    fig.savefig("0101netz_runtime_deviation_scalable.pdf")
