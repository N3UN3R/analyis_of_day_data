...
def plot_usedReductions(timestamps,timeForTicker,nested_netCostDifference, nested_numberOfPairs, nested_lokalDistance, nested_konzessionsDifference):
    ...
    # create title
    averageCommunityPrice.set_title('revidierter Simplex: eingesetzte rechtliche Rahmenbedingungen 01. Juli 2020')
   ...
   # from matplotlib.lines import Line2D
    ...
    fig.savefig("revsimplex_kruskal_usedReductions.svg")
    fig.savefig("revsimplex_usedReductions.pdf")
