...
def plot_dev(data,timestamps, sorted_runningTimes, runningTime_mean, runningTime_standard, plotting_timestamps):
    ...
    # create title
    averageCommunityPrice.set_title('revidierter Simplex: Laufzeit 01. Januar 2020')
   ...
   # fig.savefig("revsimplex_runtime_deviation_scalable.svg")
    fig.savefig("0101revsimplex_runtime_deviation_scalable.pdf")
